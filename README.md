...
3.Train the SGD Classifier model using training data.

4.Predict the species using test data and evaluate accuracy.
## Program:
```
import pandas as pd
import numpy as np
...
## Output:
<img width="843" height="409" alt="image" src="https://github.com/user-attachments/assets/0087c179-e8c7-497b-8805-58c1e4b2562b" />
